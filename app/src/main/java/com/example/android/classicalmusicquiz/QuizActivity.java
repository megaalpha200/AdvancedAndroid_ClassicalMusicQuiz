...
// TODO DONE(1): Have this Activity implement ExoPlayer.EventListener and add the required methods.
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    private void initializePlayer(Uri mediaUri) {
        if (mExoPlayer == null) {
            ...
            // TODO DONE(2): Set the ExoPlayer.EventListener to this activity
    ...
    // TODO DONE(3): Add conditional logging statements to the onPlayerStateChanged() method that log when ExoPlayer is playing or paused.
    @Override
